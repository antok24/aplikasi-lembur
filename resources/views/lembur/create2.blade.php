                  ...
                  <div class="row">
                    <div class="col-md-10">
	                    <div class="form-group">
	                      <div class="col-xs-12">
	                        ...
	                        <input type="text" name="namapegawai" class="form-control" value="{{$a->nama}}" readonly="">
	                      </div>
	                 	</div>
                      <div class="form-group">
	                      <div class="col-xs-9">
	                        <label>NIP :*</label>
	                        <input type="text" name="nip" class="form-control" value="{{$a->nip}}" readonly="">
                        </div>
	                    </div>                      
                      <div class="col-xs-4">
                      ...
                      <div class="col-xs-12">
                        <label> Nama kegiatan:*</label>
                          <input type="text" name="kegiatan" class="form-control" value="{{$a->kegiatan}}" readonly="">
                      </div>
                      <div class="col-xs-6">
                        <label>Volume :*</label>
                      ...
                      <div class="col-xs-6">
                          ...
                          <select name="satuan" class="form-control select2" style="width: 100%;" required="">
                            ...
                            <option value="Mater">Materi</option>
                    ...
                    <div class="col-xs-12">                      
                      <div class="form-group">
                        ...
                        <textarea rows="2" cols="80" name="uraiankegiatan" class="form-control" required>Harus diisi</textarea>
                      </div>
                    </div>
                    <div class="col-xs-12">
                        <button type="submit" class="btn btn-lg btn-primary center">Simpan</button>&nbsp;
                        <a href="{{ url('/EditLembur')}}" class="btn btn-warning btn-sm"><b>Klik Untuk EDIT / DELETE</b></a>
                    </div>
                  </div>
                  </div>
                  @endforeach
