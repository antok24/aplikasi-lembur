        ...
        @endif
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title"><b>Silahkan Update Password Anda</b></h3>
            </div>
            <div class="box-body" align="center">
              <form action="{{url('ChangePasswordUserAppUpdated', $user->id)}}" method="POST">
                {{csrf_field()}}
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="nip" type="text" class="form-control{{ $errors->has('nip') ? ' is-invalid' : '' }}" name="nip" value="{{$user->nip}}" readonly="" required>
	                    ...
	                    <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{$user->name}}" readonly="" required>
                      ...
                      <!-- <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="nip_atasan" type="text" class="form-control{{ $errors->has('nip_atasan') ? ' is-invalid' : '' }}" name="nip_atasan" value="{{ $user->nip_atasan }}" readonly="" required>
