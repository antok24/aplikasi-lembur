            ...
            <div class="col-xs-12">
              <div class="box box-info">
                <div class="box-header">
                  ...
                  <a class="btn btn-sm btn-success" href="{{ route('user.create')}}"><i class="fa fa-plus"></i>  Add Data Pegawai</a>
                </div>
                  ...
                  <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped table-condensed mb-none">
                      ...
                      <tr>
                        ...
                        <th width="50px"><center>UPBJJ</center></th>
                      ...
                      <tr>
                        ...
                        <td>{{$a->name}}</td>
                        <td>{{$a->email}}</td>
                        <td><center>{{$a->kode_upbjj}}</center></td>
                        <td>
                          <center>
                            ...
                            @if(isset($a->id))
                              ...
                              @endif
                              @if($a->id != '1' && $a->id !='2')
                                <a href="/user/{{encrypt($a->id)}}/mXaD" class="btn btn-xs btn-primary"><i class="fa fa-edit"></i>E d i t</a>
                                @csrf
                                @method('DELETE')
