...
<section class="content">
  ...
  <div class="box box-primary" data-select2-id="16">
    <div class="box-header with-border">
      <h3 class="box-title">Form UPBJJ:</h3>
    ...
    <!-- /.box-header -->
    <form action="{{ route('upbjj.simpan')}}" method="POST">
      @csrf
        ...
        <div class="row">
          <div class="col-md-3">
            ...
            <input type="text" name="kode_upbjj"
              id="kode_upbjj" class="form-control" placeholder="">
              @if ($errors->has('kode_upbjj'))
            <div class="form-group has-error">
              <span class="help-block">Kode UPBJJ, wajib diisi !</span>
            </div>
            @endif
          </div>
          <div class="col-md-3">
            <label>Nama UPBJJ :</label>
            <input type="text" name="nama_upbjj"
              id="nama_upbjj" class="form-control">
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <input type="text" name="alamat"
              id="alamat" class="form-control" placeholder="">
